...
class TambahMenu extends StatefulWidget {
  ...
  @override
  State<TambahMenu> createState() => _EditMenuState();
}

class _EditMenuState extends State<TambahMenu> {
  bool loading = false;
  String? _valKategori;
              ...
              Container(
                ...
                child: TextButton(
                    ...
                    onPressed: () async{
                      ...
                      var data = {
                        'id_kategori' : _valKategori.toString(),
                      ...
                      final res = await ApiService().tambahMenu(data, image);
